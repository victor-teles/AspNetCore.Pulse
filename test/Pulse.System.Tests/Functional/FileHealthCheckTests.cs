...
namespace Pulse.System.Tests.Functional;
        ...
        var webHostBuilder = new WebHostBuilder()
           .ConfigureServices(services =>
           {
               services.AddHealthChecks()
                   .AddFile(setup => setup.AddFile(Path.Combine(Directory.GetCurrentDirectory(), "Pulse.System.Tests.dll")), tags: new string[] { "file" });
           })
           .Configure(app =>
           {
