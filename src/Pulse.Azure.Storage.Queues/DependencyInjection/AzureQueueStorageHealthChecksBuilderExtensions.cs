...
using Pulse.Azure.Storage.Queues;

namespace Microsoft.Extensions.DependencyInjection;

/// <summary>
/// Extension methods to configure <see cref="AzureQueueStorageHealthCheck"/>.
/// </summary>
public static class AzureQueueStorageHealthChecksBuilderExtensions
{
    ...
    /// An optional factory to obtain <see cref="QueueServiceClient" /> instance.
    /// When not provided, <see cref="QueueServiceClient" /> is simply resolved from <see cref="IServiceProvider"/>.
    /// </param>
