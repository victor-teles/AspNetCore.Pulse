...
public static class PrometheusGatewayHealthCheckBuilderExtensions
{
    ...
    [Obsolete("This package is deprecated! We recommend using the pull model instead of Gateway. Try to use the package AspNetCore.Pulse.Prometheus.Metrics instead of.")]
