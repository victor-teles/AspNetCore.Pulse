...
public static class OracleHealthCheckBuilderExtensions
{
    ...
    internal const string HEALTH_QUERY = "select * from v$version";
    ...
    /// <param name="configure">An optional action to allow additional Oracle specific configuration.</param>
    ...
    public static IHealthChecksBuilder AddOracle(
        ...
        TimeSpan? timeout = default) => builder.AddOracle(_ => connectionString, healthQuery, configure, name, failureStatus, tags, timeout);
    ...
    public static IHealthChecksBuilder AddOracle(
        this IHealthChecksBuilder builder,
        OracleHealthCheckOptions options,
        string? name = default,
        HealthStatus? failureStatus = default,
        IEnumerable<string>? tags = default,
        TimeSpan? timeout = default)
    {
        ...
        return builder.Add(new HealthCheckRegistration(
            name ?? NAME,
            _ => new OracleHealthCheck(options),
            failureStatus,
            tags,
            timeout));
    }
