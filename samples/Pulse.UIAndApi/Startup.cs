...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services
            .AddHealthChecksUI()
            // .AddHealthChecksUI(setupSettings: settings => settings.AddWebhookNotification("webhook1", "http://webhook", "{}"))
            .AddInMemoryStorage()
            .Services
            .AddHealthChecks()
            .AddCheck<RandomHealthCheck>("random", tags: new string[] { "db", "sql", "sqlserver" })
