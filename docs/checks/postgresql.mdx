---
title: 'PostgreSQL'
description: 'This health check verifies the ability to communicate with [PostgreSQL](https://www.postgresql.org/). It uses the [Npgsql](https://www.npgsql.org/) library.'
icon: 'undefined'
---
...
<Tabs>
  <Tab title=".NET CLI">
    ```bash
    dotnet add package AspNetCore.Pulse.NpgSql --version 8.0.4
    ```
  </Tab>
  <Tab title="Package Reference">
    ```xml
    <PackageReference Include="AspNetCore.Pulse.NpgSql" Version="8.0.4" />
    ```
  </Tab>
  <Tab title="Nuget">
    <a href="https://www.nuget.org/packages/AspNetCore.Pulse.NpgSql/" target="_blank">Go to nuget page</a>
  </Tab>
</Tabs>
