---
title: 'IbmMQ'
description: 'This health check verifies the ability to communicate with a IbmMQ 9.0.+ server'
icon: 'undefined'
---
...
<Tabs>
  <Tab title=".NET CLI">
    ```bash
    dotnet add package AspNetCore.Pulse.IbmMQ --version 8.0.3
    ```
  </Tab>
  <Tab title="Package Reference">
    ```xml
    <PackageReference Include="AspNetCore.Pulse.IbmMQ" Version="8.0.3" />
    ```
  </Tab>
  <Tab title="Nuget">
    <a href="https://www.nuget.org/packages/AspNetCore.Pulse.IbmMQ/" target="_blank">Go to nuget page</a>
  </Tab>
</Tabs>
