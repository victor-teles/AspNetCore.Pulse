---
title: 'Azure File Storage Health Check'
...
<Tabs>
  <Tab title=".NET CLI">
    ```bash
    dotnet add package AspNetCore.Pulse.Azure.Storage.Files.Shares --version 8.0.3
    ```
  </Tab>
  <Tab title="Package Reference">
    ```xml
    <PackageReference Include="AspNetCore.Pulse.Azure.Storage.Files.Shares" Version="8.0.3" />
    ```
  </Tab>
  <Tab title="Nuget">
