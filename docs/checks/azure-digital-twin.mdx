...
description: 'Azure Digital Twins is an Internet of Things (IoT) platform that enables you to create a digital representation of real-world things, places, business processes, and people. For more information about Azure Digital Twin please check [Azure Digital Twin Home](https://azure.microsoft.com/en-us/services/digital-twins/)'
icon: 'undefined'
---
...
<Tabs>
  ...
  <Tab title="Package Reference">
    ```xml
    <PackageReference Include="AspNetCore.Pulse.AzureDigitalTwin" Version="8.0.4" />
    ```
  </Tab>
  <Tab title="Nuget">
