---
title: 'RabbitMQ'
description: 'This health check verifies the ability to communicate with a RabbitMQ server'
icon: 'undefined'
---
...
<Tabs>
  <Tab title=".NET CLI">
    ```bash
    dotnet add package AspNetCore.Pulse.Rabbitmq --version 8.0.3
    ```
  </Tab>
  <Tab title="Package Reference">
    ```xml
    <PackageReference Include="AspNetCore.Pulse.Rabbitmq" Version="8.0.3" />
    ```
  </Tab>
  <Tab title="Nuget">
    <a href="https://www.nuget.org/packages/AspNetCore.Pulse.Rabbitmq/" target="_blank">Go to nuget page</a>
  </Tab>
</Tabs>
