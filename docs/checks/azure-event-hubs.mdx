...
<Tabs>
  <Tab title=".NET CLI">
    ```bash
    dotnet add package AspNetCore.Pulse.Azure.Messaging.EventHubs --version 8.0.4
    ```
  </Tab>
  <Tab title="Package Reference">
    ```xml
    <PackageReference Include="AspNetCore.Pulse.Azure.Messaging.EventHubs" Version="8.0.4" />
    ```
  </Tab>
  <Tab title="Nuget">
