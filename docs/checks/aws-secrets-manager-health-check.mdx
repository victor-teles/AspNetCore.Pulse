---
title: 'AWS Secrets Manager Health Check'
...
<Tabs>
  <Tab title=".NET CLI">
    ```bash
    dotnet add package AspNetCore.Pulse.Aws.SecretsManager --version 8.0.3
    ```
  </Tab>
  <Tab title="Package Reference">
    ```xml
    <PackageReference Include="AspNetCore.Pulse.Aws.SecretsManager" Version="8.0.3" />
    ```
  </Tab>
  <Tab title="Nuget">
