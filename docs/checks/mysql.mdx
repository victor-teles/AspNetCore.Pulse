---
title: 'MySQL'
description: 'This health check verifies the ability to communicate with a MySQL Server.
...
<Tabs>
  <Tab title=".NET CLI">
    ```bash
    dotnet add package AspNetCore.Pulse.MySql --version 8.0.3
    ```
  </Tab>
  <Tab title="Package Reference">
    ```xml
    <PackageReference Include="AspNetCore.Pulse.MySql" Version="8.0.3" />
    ```
  </Tab>
  <Tab title="Nuget">
    <a href="https://www.nuget.org/packages/AspNetCore.Pulse.MySql/" target="_blank">Go to nuget page</a>
  </Tab>
</Tabs>
